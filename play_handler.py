...
class PlayProcess(object):
    ...
    def wbb_pbp(self):
        """
            ...
            Data from API endpoints:
                * womens-college-basketball/playbyplay
                * womens-college-basketball/summary
        """
        # play by play
        pbp_url = "http://cdn.espn.com/womens-college-basketball/playbyplay?gameId={}&xhr=1&render=false&userab=18".format(self.gameId)
        ...
        summary_url = "http://site.api.espn.com/apis/site/v2/sports/basketball/womens-college-basketball/summary?event={}".format(self.gameId)
    ...
    def wnba_pbp(self):
        ...
        """
        # play by play
        pbp_url = "http://cdn.espn.com/core/wnba/playbyplay?gameId={}&xhr=1&render=false&userab=18".format(self.gameId)
        pbp_resp = self.download(url=pbp_url)
        pbp_txt = {}
        if pbp_resp is not None:
            ...
            summary_resp = self.download(url=summary_url)
            summary = json.loads(summary_resp)
